#ifndef HTTPTRIPWEBSERVER_H
#define HTTPTRIPWEBSERVER_H
...
class HTTPTripServer : public Poco::Util::ServerApplication {
public:
    HTTPTripServer() : _helpRequested(false) {}
